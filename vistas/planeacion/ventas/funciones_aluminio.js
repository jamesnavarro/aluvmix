...
function insumos(cierres,rodajas,brazos,bisagras,canbis,cancie){
         var lam = $("#laminas").val();
    var cod = $("#codigo0").val();
    var des = $("#descripcion0").val();
    var ancho = $("#ancho").val();
    ...
    $.ajax({
        type:'GET',
        data:'lam='+lam+'&brazos='+brazos+'&bisagras='+bisagras+'&cancie='+cancie+'&canbis='+canbis+'&rodajas='+rodajas+'&cierres='+cierres+'&cod='+cod+'&inst='+inst+'&desp='+desp+'&despalu='+despalu+'&despacc='+despacc+'&inter='+inter+'&espa='+espa+'&des='+des+'&ancho='+ancho+'&alto='+alto+'&cant='+cant+'&per='+per+'&boq='+boq+'&pelicula='+pelicula+'&sw=43',
...
function totalizar(){
    ...
    var cperfil4 = $("#total_perfil_costo4").val();
     ...
     var t_vid = $("#dtot").val(); //total costo vidrio
     ...
     var t_mob = $("#total_fabricacion").val(); // total de mano de obra
     var t_ins = $("#total_instalacion").val();
...
function save_vidrio(n){
    ...
    $.ajax({
            post:'GET',
            data:'cod='+cod+'&idparvid='+idparvid+'&modulo='+modulo+'&desparvid='+desparvid+'&traz='+traz+'&mob='+mobt+'&des='+encodeURIComponent(des)+'&des0='+encodeURIComponent(des0)+'&estado='+estado+'&idlam='+idlam+'&item='+item+'&cot='+cot+'&lam='+lam+'&ubc='+ubc+'&obse='+obse+'&itemv='+itemv+'&pelicula='+pelicula+'&carton='+carton+'&inst='+inst+'&despvid='+desp+'&despalu='+despalu+'&despacc='+despacc+'&cot='+cot+'&ancho='+ancho+'&alto='+alto+'&cant='+cant+'&per='+per+'&boq='+boq+'&desc='+desc+'&precio='+precio+'&comision='+comision+'&reposicion='+reposicion+'&imprevisto='+imprevisto+'&utilidad='+utilidad+'&sw=28',
            url:'acciones_alu.php',
            success:function(a){
                var p = eval(a);
               $("#idlam"+n).val(p[0]);
                ...
                $.ajax({
                    ...
                    success:function(a){
                        ...
                        pasar_datos_dt(p[2]);
                            ...
                            mostrar_compuestos();
                            insumos(p[49],p[50],p[56],p[57],p[58],p[59]);
...
function CargarDatosBasicos(){
    var item = $("#item").val();
                    ...
                    success:function(a){
                        ...
                        perfiles_rieles(p[2],p[46],p[53]);
                        perfiles_alfajia(p[2],p[47],p[53]);
                        insumos(p[49],p[50],p[56],p[57],p[58]);
                        pre_mostrar_rejilla(p[48],p[51],p[53]);//NO
                        mostrar_instalacion(p[2]); //NO
...
function codvidrios(){
    $("input[name=item]:checked").each(function(){
				var id = $(this).attr("id");
                                ...
                                $("#codigo"+modu+"00").val(cod);
                                $("#descripcion"+modu+"00").val(desc);
...
console.log('cod:'+cod);
    $.ajax({
        type:'GET',
        data:'cod='+cod+'&color='+color+'&riel='+riel+'&alfa='+alfa+'&cant='+cant+'&desp='+desp+'&ancho='+ancho+'&alto='+alto+'&rej='+rej+'&ancfd='+ancfd+'&ancfi='+ancfi+'&alcfs='+alcfs+'&alcfi='+alcfi+'&sw=42',
        url:'acciones_alu.php',
        success : function(d){
            $("#formperfiles").html(d);
