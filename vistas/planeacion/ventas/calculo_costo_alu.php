...
$despalu = (100-$_GET['despalu'])/100;
$totdesalu = $total_alum / $despalu;
$suma_acc = $_GET['t_acc'];// + $_GET['t_adi']  se quito
$total_acc = $suma_acc;
$despacc = (100-$_GET['despacc'])/100;
$totdesacc=$suma_acc/$despacc;
...
$total_costo = $totdesacc +$totdesalu + $totdesvid +  $totalespa + $suma_acc + $total_alum  + $total_acc + $fabricacion + $instalacion + $poli;
