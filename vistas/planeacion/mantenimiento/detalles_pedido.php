	...
	{    
       ...
       $contador =  strlen($descripcion);
                ...
                $table = $table.'<tr><td></td><td width="7%">'
                        ...
                        <td class="hidden-phone"><input type="text" id="vlr'.$cont.'" onchange="updateitemped('.$cont.')"  value="'.number_format($row["valor_und"],0,'','').'" style="width:100%"></td>
                        <td class="hidden-phone"><input type="text" id="tot'.$cont.'"  value="'.number_format(($row["valor_und"]*$row['cantidad']),0,'','').'" style="width:100%" disabled>
