...
?>
<script src="../vistas/planeacion/orden/funciones.js?<?php echo rand(1,100) ?>"></script>
...
<!--                                     <option value="5">5. Externa con Desc</option> -->
                                     <option value="6">6. Ordenes Galapa</option> 
