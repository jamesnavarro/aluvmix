...
//            echo ($tk ) .'';
      ...
      if($row['pelicula']=='No Aplica'){
          ...
          $query = mysqli_query($con2,"SELECT * FROM referencias a, cotizaciones_materiales b where a.id_referencia=b.id_material and b.id_cotizacion=".$_GET['cot']." and estad_mat=0 ");
        ...
        while($f = mysqli_fetch_array($query)){
            ...
            $table = $table.'<tr><td><img src="../../../imagenes/buscar.png" onclick="buscarcodfom('.$cont.')"></td><td width="7%">'
                        ...
                        <td class="hidden-phone"><input type="text"  id="med'.$cont.'" value="'.$f['med'].'" style="width:100%"></td>
                        ...
                        <input type="hidden" id="obs'.$cont.'" value="" style="width:100%">'
                        . '<input type="hidden" id="item'.$cont.'" value="'.$f['id_cot_mat'].'" style="width:100%">'
                        . '<td><input type="checkbox" id="'.$cont.'" name="item" checked   onclick="aprobar_items2('.$cont.')"><span id="con'.$cont.'">'.$contador.'</span></td></tr>'; 
        }
        
        $query2 = mysqli_query($con2,"SELECT * FROM referencia_mo a, cotizaciones_servicios b where a.id_ref_mo=b.id_servicio and b.id_cotizacion=".$_GET['cot']." and id_cot_mas=0 and estado_serv='0'  ");
        ...
        while($f = mysqli_fetch_array($query2)){
            ...
            $table = $table.'<tr><td><img src="../../../imagenes/buscar.png" onclick="buscarcodfom('.$cont.')"></td><td width="7%">'
                        ...
                        <input type="hidden" id="obs'.$cont.'" value="" style="width:100%">'
                        . '<input type="hidden" id="item'.$cont.'" value="'.$f['id_cot_serv'].'" style="width:100%">'
                        . '<td><input type="checkbox" id="'.$cont.'" name="item" checked   onclick="aprobar_items3('.$cont.')"><span id="con'.$cont.'">'.$contador.'</span></td></tr>'; 
        }
