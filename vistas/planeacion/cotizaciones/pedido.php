...
<html>
    <head>
        ...
        <script src="funciones.js?ve=<?php echo rand(1, 999) ?>"></script>
    </head>
    <body>
        <div>
...
<!--                   <button onclick="anul_c();"><img src="../../images/eliminar.png"  title="Salir del Formulario">Anular</button>-->
                   <button onclick="aiu(<?php echo $_GET['cot'];?>,'<?php echo $_GET['linea'];?>');"><img src="../../images/ordenes.png" style="height: 30px" title="Salir del Formulario">Pasar AIU</button>
                   ...
                   <div id="detalle" class="tab-pane fade in active">
                       ...
                       <table class="tbl-registro" width="100%">
                           ...
                           <tr>
                               ...
                               <td>Plazo </td>
                               <td><input type="text" id="cre" style="width: 150px" value="" disabled></td>
                           </tr>  
                           <tr>
