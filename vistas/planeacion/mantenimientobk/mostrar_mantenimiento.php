...
//				  }
				...
				$table = $table . '<td width="15%">' . strtoupper($nombre) . '<br>' . $led . ' ' . $tiempo33 . '<a href="#" onclick="ver_cotizacion2('.$row['id_cot'].','.$linea.');">*</a> </td>';
				...
				$table = $table . '<td width="10%">' . strtoupper($row["usuario_pedido"]) . '</td>';
