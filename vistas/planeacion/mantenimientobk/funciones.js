...
function ver_cotizacion(cot,linea){
        ...
        function ver_cotizacion2(cot,linea){
             window.open('../vistas/planeacion/mantenimiento_1/pedido.php?cot='+cot+'&linea='+linea,'seg1','width=1300px,height=700');  
        }
        function sucursales(){
            var cot = $("#cot").val();
...
//                  $.ajax({
//                      type:'GET',
//                      url:'http://localhost:8989/api/MAELOTE/'+cod,
//                      contentType: 'application/json',
//                      success: function(da){
//                         var p = eval(da);
//                         contador++;
...
//          });
//          if(ct!==contador){
//              alert("No puedes enviar estos datos a FOMPLUS, Verifica los colores y actualizalos!"+contador);
//              return false;
//          }
