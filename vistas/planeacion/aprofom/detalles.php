      ...
      if($row['pelicula']=='No Aplica'){
               ...
               $gt +=$tota;
                $table = $table.'<tr><td><img src="../../../imagenes/buscar.png" onclick="buscarcodfom('.$cont.')"></td><td width="7%">'
                        ...
                        <td width="25%"><textarea  id="des'.$cont.'" rows="2" style="width:100%">'.$ref.'</textarea></td>                     
                        ...
                        <td class="hidden-phone"><input type="text" id="vlr'.$cont.'" value="'.number_format($preund,2,',','.').'" style="width:100%"></td>
