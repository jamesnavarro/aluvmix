...
?>
<script src="../vistas/planeacion/aprofom/funciones.js?<?php echo rand(100,200) ?>"></script>
<script> 
$(document).ready(function(){
 ...
 <div class="tab-content">
			...
			<th width="15%">CLIENTES | OBRA</th>
		
			<th width="30%">FECHA REGISTRO</th>
			<th width="5%">GENERADO</th>
			<th width="10%">ESTADO</th>
			<th class="hidden-phone">GENERAR OP</th>
			</tr>
                        <tr>
                            <td>-</td>
                            ...
                            <td><input type="text"  autocomplete="off" class="span12" id="nom" placeholder="Nombre del cliente" value="" style="width: 100%"/><input type="text"  autocomplete="off" class="span12" id="obr" placeholder="Obra" value="" style="width: 100%"/></td>
                            <td><input type="date"  autocomplete="off"  id="freg" placeholder="" value="" style="width: 130px"/>al<input type="date"  autocomplete="off"  id="fregf" placeholder="" value="" style="width: 130px"/></td>
