...
<?php
    ...
    <html>
        ...
        <body  <?php if($pr=='En proceso'){  ?>style="background-image: url('../images/sin.png');background-repeat: no-repeat;background-size: 480px;background-position-x: 400px;background-position-y: 250px" <?php } ?> onload="window.print();">
<!--          onload="window.print()"-->
            ...
            $aa36 = 35 * $_GET['col'];
            $aa37 = 36 * $_GET['col'];
             $request = mysqli_query($con,"select *, a.ruta as imc, b.ruta as imp,a.ancho,a.alto from cotizacion_item a, producto b where a.codigo=b.codigo and a.id_cot='".$_GET['cot']."' and a.estado='Guardado' and a.id_cot_principal=0 and compuesto=0");
