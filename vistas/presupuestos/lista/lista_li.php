...
include "../../../modelo/conexionv1.php";
 $ite= $_GET['ite'];
      ...
      $modi= $_GET['modi'];
      $page= $_GET['page'];
      $request = mysqli_query($con2,"SELECT count(*) FROM producto where "
      . "linea like '".$line."%' and codigo like '%".$codi."%' and producto like '%".$desc."%' "
      ...
      $num_items = 0;
        ...
        if(isset($_POST['linea'])){
           ...
           echo '</td></tr>';
           $result2 = mysqli_query($con2, "SELECT * FROM producto where linea like '".$line."%' and codigo like '%".$codi."%' and producto like '%".$desc."%'  and  fecha_adm like '%".$ulti."%' and modificado like '%".$modi."%' $it order by id_p desc  ".$limit);
      ...
      $led2 = '<img src="../imagenes/ojo.png">';
           echo '<tr>'
        . '<td>'.$fila['id_p'].'</td>'
        . '<td><input type="text" id="iva'.$fila['id_p'].'" value="'.$fila['ivapro'].'" style="width:100%" onchange="update_iva('.$fila['id_p'].')"></td>'
