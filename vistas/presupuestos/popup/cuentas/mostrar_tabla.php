...
$request=mysqli_query($con,'SELECT pro_referencia FROM productos where pro_referencia like "%'.$_GET['ref'].'%"  and pro_nombre like "%'.$_GET['des'].'%" and linea="Aluminio"  ');
            if($request){
            ...
            echo '<tr><td colspan="2">';
                ...
                ?>
                                    ...
                                    $sql = mysqli_query($con,"SELECT * FROM `productos` where pro_referencia like '%".$_GET['ref']."%'  and pro_nombre like '%".$_GET['des']."%' and linea='Aluminio' "
                                            . " ".$limit);
			$item = 0;
