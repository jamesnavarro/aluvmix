...
//				  }
                                        if($row['linea']=='Vidrio'){
                                            $btnver = '<button type="button" onclick="ver_cotizacion('.$row['id_cot'].');"><img src="../images/view.png" /> </button>';
                                        }else{
                                            $btnver = '<a href="../../vistas/?id=new_fac&cot=' . $row['id_cot'] . '&cli=' . $row['id_tercero'] . '"><button type="button"><img src="../images/view.png" /> </button></a>';
                                        }
                                        if($row['tecnica']==''){
                                            $tec = '';
                                        }
...
//				$table = $table . '<td width="5%">' . $documento . '</td>';
				...
				$table = $table . '<td class="hidden-phone">' . $v . '</td>';
				$table = $table . '<td class="hidden-phone">' . $open . '</td>';
				$table = $table . '</tr>';
			        }
