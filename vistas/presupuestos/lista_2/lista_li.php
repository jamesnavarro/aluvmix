 ...
 $ite= $_GET['ite'];
      ...
      $page= $_GET['page'];
       $request = mysqli_query($con,"SELECT count(*) FROM producto where "
               ...
               . " and  fecha_adm like '%".$ulti."%' and modificado like '%".$modi."%'  and estado_producto='0' $it ");
  ...
  $num_items = 0;
          ...
          $page = 1;
           ...
           echo '<tr><td colspan="14">';         
              ...
              echo '</td></tr>';
$result2 = mysqli_query($con, "SELECT * FROM producto where  revisado=0 and linea like '%".$line."%' and codigo like '%".$codi."%' and producto like '%".$desc."%'  and  fecha_adm like '%".$ulti."%' and modificado like '%".$modi."%' $it  and estado_producto='0' order by id_p desc  ".$limit);
