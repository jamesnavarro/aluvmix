...
?>
							...
							<tbody>
								...
								$totalp = 0;
									...
									$tabla_principal = $tabla_principal.'<td>'.$row['codigo'].'</td>';
                                                                        $tabla_principal = $tabla_principal.'<td>'.$row['producto'].' ('.$row['can'].' de '.$cantidad_general.') '.$medida_general.'</td>';
									$tabla_principal = $tabla_principal.'<td><center>Und</center></td>';
                                                                        $tabla_principal = $tabla_principal.'<td style="text-align:right">'.$row['can'].'<input type="hidden" id="canop" value="'.$row['can'].'"></td>';
            ...
            consultarvalorop('<?php echo $tipofom ?>','<?php echo $OPFC ?>','<?php echo $cantidad_ordenada ?>','<?php echo $medida_general ?>','<?php echo $opgeneral ?>');
                                                            ...
                                                            <tr>
                                                            <td colspan="7">MATERIA PRIMA <?php echo $id_cot.' '.$link ?></td>
                                                        </tr>
                                                        <tr>
									<th class="center">Referencia*</th>
                                                                        <th class="center">Descripcion Articulo</th>
