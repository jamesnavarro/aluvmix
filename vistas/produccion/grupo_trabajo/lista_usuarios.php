...
$request_ac=mysqli_query($con2,"SELECT * FROM subproceso a, grupo b, grupo_det c, usuarios d where d.id_user=c.id_user and b.id_g=c.id_g and a.id_subpro=b.id_area and b.id_g=".$_GET['id']." ");
...
//    echo'<hr>';
       $table = '<table class="table table-bordered table-striped table-hover" id="">';
             ...
             $table = $table.'<thead >';
              ...
              $table = $table.'<th width="5%">'.'Activos'.'</th>';
                $table = $table.'<th width="5%">'.'Inasistencia'.'</th>';
              $table = $table.'</tr>';
              $table = $table.'</thead>';
	...
	{       
                ...
                $table = $table.'<tr><td width="5%">'.$t.'</a></td>'
                    ...
                    . '<td><button onclick="borrar_u('.$row['id_user'].','.$_GET['id'].')" class="glyphicon glyphicon-list"> </button></td>'
                    . '</tr>';   
