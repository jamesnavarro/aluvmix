...
<ul class="nav nav-tabs" id="myTab">
 ...
 <tr class="bg-info">
    ...
    <h3 class="bg-info text-center"><B>SERVICIOS PUBLICOS</B></h3>  
    </tbody>
</table>
          ...
          <div id="agregar" class="tab-pane fade in">
                   ...
                   <div class="form-group">
                     <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Nombre del servicio publico</label>
                      <div class="col-sm-9">
                       <div class="col-sm-9">
