...
function inv_bodega_popup3() {
    window.open("../popup/bodega_t/bodega.php", "Bodegas", "width=500px , height=600px");
}
...
function comp_popup(){
    ...
    if(tipo=='ENTRADA'){
        window.open("../popup/compras/clases.php", "compra", "width=800px , height=600px");
    }else{
        window.open("../popup/desglose/clases.php", "compra", "width=800px , height=600px");
    }
...
function inv_mov_sald(tipo) {
    ...
    var loc = $("#loc").val();
    if(tipo=='ENTRADA'){
        window.open("../popup/productos/producto.php", "Productos", "width=500px , height=600px");
    }else{
        window.open("../popup/existencias/producto.php?loc="+loc, "Productos", "width=700px , height=600px");
    }
}
