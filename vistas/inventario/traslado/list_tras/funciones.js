 ...
 function inv_buscar_codigo(){
     var cod = $("#fdes").val();
      $.ajax({
                type: 'GET',
                data: 'cod='+cod+'&sw=4',
                url: '../vistas/inventario/movimientos/list_tras/acciones.php',
         success: function(t) {
             var t = eval(t);
    ...
    function mostrar_line(page){
        ...
        $.ajax({
                ...
                url: '../vistas/inventario/movimientos/list_tras/lista.php',
            success: function(d){
...
function dar_entrada(id) {
    $('<form action="../vistas/inventario/movimientos/entrada_traslado.php" method="post" target="_blank"><input type="hidden" name="id" value="'+id+'"/></form>')
