...
<html>
    <head>
        ...
        <script src="controlador.js?<?php echo rand(1,100) ?>"></script>
    </head>
    <body>
        <div>
                   ...
                   <div id="detalle" class="tab-pane fade in active">
                       <table class="tbl-registro" width="100%">
                           <tr>
                               ...
                               <td><input type="text" value="2006" id="doc" style="width: 100px" disabled>
                                   <input type="text" id="ndoc" value="SALIDAS POR TRASLADO ENTRE BODEGAS" style="width: 250px" disabled></td>
                               <td>Fecha</td>
                           ...
                           <tr>
                               ...
                               <td><input type="text" onchange="bus_cencost();" id="cc"  style="width: 100px" disabled> <input type="text" id="centro" style="width: 250px" disabled></td>
                               <td>SEDE</td>
                           ...
                           <tr>
                                <td>No. Documento</td>
                                <td><input type="text" id="compra" style="width: 100px" onchange="ordenes()" disabled><button onclick="comp_popup();" id="btnn_mov">00</button> "Orden de compra ó Orden de Producción"</td>
                                 <td>Remision N°.</td>
                           ...
                           <tr>
                               ...
                               <td><input type="text" onchange="bus_bodega_tras();" id="loc_tras" style="width: 100px"><button onclick="inv_bodega_popup3();" id="btn_bod">00</button>  <input type="text" id="nloc_tras" style="width: 250px" disabled></td>
                             
                           </tr>
                           <tr>
                                
                              <td>Tercero</td>
                              <td><input type="text" value="800112904" id="nombrepro" style="width: 100px" > 
                                  <input type="text" value="TEMPLADO S A" id="nterc" style="width: 250px" disabled></td>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="text" id="preu" name="preu">
                    </div>
                  </div><br><br>
                  <div class="form-group">
