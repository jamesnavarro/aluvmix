...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Formulario de Registro Load</title>
    ...
    <body>
        ...
        <div class="border">
               ...
               <div  style="float:left">
                   <button type="button"  id="Guardar" onclick="save_total();"><img src="../../images/guardar.png"> Guardar</button> 
                   <button onclick="Limpiar();"><img src="../../images/nuevo.png" class="panel"  title="Nuevo Registro"></button>
                   ...
                   <div id="detalle" class="tab-pane fade in active">
                       <table class="tbl-registro" width="100%">
                           <tr>
                               ...
                               <td><input type="text" id="doc" style="width: 100px"><img src="../../images/buscar.png" onclick="inv_ti_mov_popup();" style="cursor: pointer"> <input type="text" id="ndoc" style="width: 200px" placeholder="Descripcion" disabled></td>
                               <td>Fecha</td>
                               <td><input type="text" id="FecReg" style="width:250px" value="" disabled> <span id="es"></span></td>
                               <td>Radicado</td>
                           ...
                           <tr>
                               ...
                               <td><input type="text" id="cc" style="width: 100px"><img src="../../images/buscar.png" onclick="inv_centro_costo_popup();" style="cursor: pointer"> <input type="text" id="centro" style="width: 250px" placeholder="Descripcion" disabled></td>
                           ...
                           <tr>
                                <td>Orden Compra</td>
                                <td><input type="text" id="compra" style="width: 80px"></td>
                                 <td>Remision N°.</td>
                               <td><input type="text" id="factura" style="width: 80px" ></td>
                           </tr>
                           <tr>
                               <td>Bodega:</td> 
                           ...
                           <tr>
                              ...
                              <td>Tercero</td>
                               ...
                               <td>Diferencia</td>
                               <td><input type="number" id="diferencia" style="width: 100px" ></td>
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                 <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Agregar Productos a Inventario</h4>
                </div>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Formulario de Registro old</title>
        <link rel="stylesheet" href="../../assets/css/bootstrap.min.css" />
        <link rel="stylesheet" href="../../assets/font-awesome/4.5.0/css/font-awesome.min.css" />
        <link rel="stylesheet" href="../../assets/css/jquery-ui.custom.min.css" />
        <link rel="stylesheet" href="../../assets/css/jquery.gritter.min.css" />
...
<html>
  <head>
        <meta charset="UTF-8">
        <title>Formulario de Registro Nuevo</title>
        <link rel="stylesheet" href="../../assets/css/bootstrap.min.css" />
        <link rel="stylesheet" href="../../assets/font-awesome/4.5.0/css/font-awesome.min.css" />
        <link rel="stylesheet" href="../../assets/css/jquery-ui.custom.min.css" />
        <link rel="stylesheet" href="../../assets/css/jquery.gritter.min.css" />
                         ...
                         <table class="tbl-registro" width="100%">
                             ...
                             <tr>
                                <td></td>
                                 ...
                                 <td><input type="text" id="descarga" style="width: 80px" disabled value="ENTRADA"></td>
                                 <td></td>
                                 <td><button type="button" id="continuar" onclick="prueba();"><img src="../../images/play.png"> Continuar</button></td>
                             </tr> 
                         </table>
                         <div id="hiddentab">
                         <table width="100%">
