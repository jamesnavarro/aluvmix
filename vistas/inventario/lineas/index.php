...
?>
<script src="../vistas/inventario/lineas/funciones.js?<?php echo rand(1,100) ?>"></script>
                ...
                <div class="modal-header">
                  <h4 class="modal-title">FORMULARIO</h4>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="fcod" onchange="inv_buscar_linea();" placeholder="digite el codigo" class="col-xs-10 col-sm-5" />
                    </div>
                    </div>
                    <div class="form-group">
