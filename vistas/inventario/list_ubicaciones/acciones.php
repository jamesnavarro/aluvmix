...
switch ($_GET['sw']) {
        ...
        case 3:
            $id=$_GET['id'];
                 ...
                 echo '<tr><td>'.$id.'</td><td colspan="3">'.$saldo.'</td><td>'.$btn.'</td></tr>';
                 ...
                 $cod=$_GET['cod'];
                  $col=$_GET['col'];
                   $med=$_GET['med'];
                    $ubi=$_GET['ubi'];
                     $can=$_GET['can'];
                     mysqli_query($con,"update relacion_ubicaciones set stock_ubi='$can' where codigo_pro='$cod' and bod_codigo='$bod' and color_ubi='$col' and medida='$med'  ");
