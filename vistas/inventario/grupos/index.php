...
?>
<script src="../vistas/inventario/grupos/funciones.js?<?php echo rand(1,100) ?>"></script>
                ...
                <div class="modal-header">
                  <h4 class="modal-title">FORMULARIO</h4>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Descripcion del grupo </label>
                    <div class="col-sm-9">
