...
?>
<script src="../vistas/inventario/modelos/funciones.js?<?php echo rand(1,100) ?>"></script>
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active" id="marca1">
	   <a data-toggle="tab" href="#lin1">
           ...
           <li id="marca2">
               <a data-toggle="tab" onclick="limpiar_modelo();" href="#lin2"><h6><B>Agregar</B></h6></a>
           </li>
        </ul>
 ...
 <tbody id="mostrar_tabla">
          ...
          <div id="lin2" class="tab-pane fade in">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="fcod" onchange="inv_buscar_marca();" placeholder="digite el codigo" class="col-xs-10 col-sm-5" />
                    </div>
                    </div>
                    <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Descripcion de la linea </label>
                    <div class="col-sm-9">
                    <input type="text" id="fdes" placeholder="descripcion de la linea" class="col-xs-10 col-sm-5" />
                    </div>
                    </div>
                       <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Nombre resumido </label>
                    <div class="col-sm-9">
                    <input type="text" id="fres" placeholder="descripcion de la linea" class="col-xs-10 col-sm-5" />
                    </div>
                    </div>
                       <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     ...
                     <button type="button" class="btn btn-success" onclick="guardar_modelo()">Guardar</button>
                     <button type="button" class="btn btn-danger" onclick="limpiar_modelo()">Nuevo
