$(function(){
     $("#mostrar_tabla").html(mostrar_marca(1));
 ...
 function inv_buscar_marca(){
     var cod = $("#fcod").val();
      $.ajax({
                type: 'GET',
                data: 'cod='+cod+'&sw=4',
                url: '../vistas/inventario/marca/acciones.php',
         success: function(t) {
             var t = eval(t);
              $("#fcod").val(cod);
              $("#fdes").val(t[1]);
    ...
    function mostrar_marca(page){
        ...
        $.ajax({
                ...
                url: '../vistas/inventario/marca/lista.php',
            success: function(d){
