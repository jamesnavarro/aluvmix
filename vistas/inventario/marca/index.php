...
?>
<script src="../vistas/inventario/marca/funciones.js?<?php echo rand(1,100) ?>"></script>
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active" id="marca1">
	   <a data-toggle="tab" href="#lin1">
           ...
           <li id="marca2">
               <a data-toggle="tab" onclick="limpiar_marca();" href="#lin2"><h6><B>Agregar</B></h6></a>
           </li>
        </ul>
          ...
          <div id="lin2" class="tab-pane fade in">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     ...
                     <button type="button" class="btn btn-success" onclick="guardar_marca()">Guardar</button>
                     <button type="button" class="btn btn-danger" onclick="limpiar_marca()">Nuevo
