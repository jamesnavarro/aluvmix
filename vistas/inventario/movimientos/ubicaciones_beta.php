             ...
             <tr class="bg-info">
                 ...
                 <tbody id="mostrar_dados">
                               		<?php
                                        ...
                                        if(isset($_GET['id'])){
                                            $fun = "sedin2($send,".$_GET['id'].")";
                                        }else{
                                             $fun ="sedin($send)";
                                        }
                                        echo '<td><div class="radio">
                                                  <label>
                                                  <input name="form-field-radio" type="radio" class="ace input-lg tooltip-error" onclick="'.$fun.'" title="" data-original-title="Top Danger">
...
<script type="text/javascript">
  function sedin(ref) {
    window.opener.pasar_info(ref);
    window.close();
  }
  function sedin2(ref,id) {
    window.opener.pasar_ubicacion(ref,id);
    window.close();
  }
</script>
