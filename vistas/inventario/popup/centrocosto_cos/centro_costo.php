...
<script src="../centrocosto/documentos/funciones.js?<?php echo rand(1,100) ?>"></script>
<script language="javascript" type="text/javascript">
function pasar(cod,nom){
   window.opener.document.getElementById("cencosto").value=cod;
    window.opener.document.getElementById("nomcos").value=nom;
   window.close();
}
</script>
