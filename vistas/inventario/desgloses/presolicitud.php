...
<!--                   <button  onclick="Imprimir();"><img src="../../images/printer.png" title="Imprimir Registro"> Imprimir</button>-->
                   ...
                   <button onclick="imprimir_alum();"><img src="../../images/printer.png"  title="Salir del Formulario">PDF</button>
...
<div  class="modal fade" id="ModalEditarX" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
