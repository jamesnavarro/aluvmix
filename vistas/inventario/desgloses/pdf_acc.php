				 ...
				 <div class="container" style="margin-top: 3;font-size: 14px;">
				 	...
				 	<div style="width: 100%;font-size: 11px">
				 		...
				 		<table id="dynamic-table" style="width: 100%;font-size: 11px">
							...
							<tbody>
	<?php
	$reques=mysqli_query($con2,"SELECT *, a.medida, sum(a.medida*a.cantidad) as med, sum(a.cantidad) as can FROM desgloses_material a, referencias b where  a.linea='Accesorios' and  a.codigo_pro=b.codigo and a.id_cot=".$_GET["cot"]." and cantidad!=0 group by a.codigo_pro order by a.referencia asc ");
