...
?>
<script src="../vistas/contabilidad/area_trab/funciones.js?<?php echo rand(1,100) ?>"></script>
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active" id="marca1">
	   <a data-toggle="tab" href="#lin1">
           ...
           <li id="marca2">
               <a data-toggle="tab" onclick="limpiar_areat();" href="#lin2"><h6><B>Crear area</B></h6></a>
           </li>
        </ul>
          ...
          <div id="lin2" class="tab-pane fade in">
                   <div class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                            <input type="text" id="id_areat" class="col-xs-10 col-sm-5" disabled />
                         </div>
                        </div>  
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                         <input type="text" id="nombre_aret" placeholder="escriba su contraseña" class="col-xs-10 col-sm-5" />
                         </div>
                        </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-9">
                         <select id="est_areat" class="col-xs-10 col-sm-5">
                            <option value=""></option>
                            <option value="0">Activo</option>
                            <option value="1">Inactivo</option>
                         </select>
                  ...
                  <button type="button" class="btn btn-success" onclick="guardar_areat()">Guardar</button>
                  <button type="button" class="btn btn-danger" onclick="limpiar_areat()">Nuevo
