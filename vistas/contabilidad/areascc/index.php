...
?>
<script src="../vistas/contabilidad/areascc/funciones.js?<?php echo rand(1,100) ?>"></script>
                ...
                <div class="modal-header">
                  <h4 class="modal-title">Formulario</h4>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Descripcion de areas </label>
                    <div class="col-sm-9">
                    <input type="text" id="fdes" placeholder="descripcion de areas" class="col-xs-10 col-sm-5" />
                    </div>
                    </div>
                       <div class="form-group">
