...
<button type="button" class="btn btn-info btn-sm" onclick="pdf3()"> <img src="../imagenes/print.png" width="15px"/> Imp.x Grupo</button>
                       ...
                       <div class="tab-content">
                           <div id="home" class="tab-pane fade active in">
                               <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Tipo de cuenta</label>
                                         <div class="col-sm-9">
                                             <input type="hidden" id="ordenc" placeholder="" class="col-xs-10 col-sm-9" disabled />
                                              <select id="tipo_f" class="form-control">
                                                <option value="1"> 1- Orden</option>
                                                <option value="2"> 2- Cotizacion</option>
                                                <option value="3"> 3- Consignacion</option>
                                                <option value="4"> 4- Orden Ext</option>
                                                <option value="5"> 5- Orden Suc</option>
                                                <option value="6"> 6- Importacion</option>
                                                <option value="7"> 7- Nacionalizacio</option>
                                            </select>
                                         </div>
                                      </div>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="form-group">
                                       <label class="col-sm-3 control-label no-padding-right" for="form-field-2">IVA ?</label>
                                         <div class="col-sm-3">
                                             <input type="text" id="siva" placeholder="" class="col-xs-10 col-sm-6" disabled value=""/>
                                         </div>
                                       <label class="col-sm-3 control-label no-padding-right" for="form-field-2">ReteFuente ?</label>
                                         <div class="col-sm-3">
                                             <input type="text" id="sret" placeholder="" class="col-xs-10 col-sm-6" disabled value=""/>
                                         </div>
                                       <label class="col-sm-3 control-label no-padding-right" for="form-field-2">ReteIca ?</label>
                                         <div class="col-sm-3">
                                             <input type="text" id="sica" placeholder="" class="col-xs-10 col-sm-6" disabled value=""/>
                                         </div>
                                       <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Actividad Economica</label>
                                         <div class="col-sm-3">
                                             <input type="text" id="sact" placeholder="" class="col-xs-10 col-sm-6" disabled value=""/>
                                         </div>
                                     </div>
                                <div class="form-group">
...
<div class="modal fade" id="modalup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group col-xs-3">
            ...
            <input type="text" class="form-control" id="fcod" onchange="buscarcod2()">
            <input type="hidden" class="form-control" id="fid">
          </div>
          <div class="form-group col-xs-9">
            <label for="message-text" class="col-form-label">Descripcion:</label>
            <textarea class="form-control" id="fdes"></textarea>
          </div>
          <div class="row">
                <div class="form-group col-xs-6">
                <label for="recipient-name" class="col-form-label">Color:</label>
                <input type="text" class="form-control" id="fcol">
              </div>
                <div class="form-group col-xs-6">
                <label for="recipient-name" class="col-form-label">Medida:</label>
                <input type="text" class="form-control" id="fmed">
              </div>
           </div>
           <div class="row">
            <div class="form-group col-xs-6">
                <label for="recipient-name" class="col-form-label">Precio:</label>
                <input type="text" class="form-control" id="fpre">
            </div>
            <div class="form-group col-xs-3">
                <label for="recipient-name" class="col-form-label">Cantidad:</label>
                <input type="text" class="form-control" id="fcan">
            </div>
                <div class="form-group col-xs-3">
                <label for="recipient-name" class="col-form-label">Aprobada:</label>
                <input type="text" class="form-control" id="fapr" disabled>
              </div>
                </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-danger" onclick="borraritems()">Borrar Items</button>
        <button type="button" class="btn btn-primary" onclick="savecambios()">Guardar Cambios</button>
      </div>
    </div>
  </div>
</div>
  <script>
     function entrega() {
         ...
         if(cant=='0'){
             alert("¡Debes de seleccionar por lo menos un items!");
             return false;
         }
      $("#sede").val('');
      $("#nombrepro").val('');
