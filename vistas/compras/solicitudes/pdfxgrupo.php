...
<html lang="sp">
    ...
    <center>
        ...
        <tbody>
        <?php 
        $result = mysqli_query($con,"select * from solicitudes_item a, productos_var b where a.codigo=b.codigo and a.id_sol='".$_GET['id']."' order by b.grupo asc ");
        $total2=0;
        $grupo = '';
        $items = 0;
        while($fila = mysqli_fetch_array($result)){
            ...
            $items++;
            if($items==1){
                echo '<tr><td colspan="9"><center><b>GRUPO '.$fila['grupo'].'</b></center></td>';
            }else if($fila['grupo']!=$grupo){
                echo '<tr><td colspan="9"><center><b>GRUPO '.$fila['grupo'].'</b></center></td>';
            }
