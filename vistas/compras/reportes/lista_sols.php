...
if(isset($_SESSION['k_username'])){
    ...
    $n_obs= $_GET['n_obs'];
            ...
            $request = mysqli_query($con,"SELECT count(*) FROM orden_compra a,orden_compra_detalle b where a.codigo=b.codigo_orden and a.ordenfom like '%".$_GET['sol']."' and a.nom_ter like '%".$_GET['pro']."%'  and b.codigo!='9999' and b.codigo like '%".$_GET['cod']."%' and b.descripcion like '%".$_GET['des']."%' and a.fecha like '%".$_GET['n_fech']."%' and a.observaciones_compra like '%".$_GET['n_obs']."%' ");
...
$request_ac = mysqli_query($con,"SELECT * FROM orden_compra a,orden_compra_detalle b where a.codigo=b.codigo_orden  and a.ordenfom like '%".$_GET['sol']."' and a.nom_ter like '%".$_GET['pro']."%' and b.codigo!='9999' and b.codigo like '%".$_GET['cod']."%' and b.descripcion like '%".$_GET['des']."%' and a.fecha like '%".$_GET['n_fech']."%' and  a.observaciones_compra like '%".$_GET['n_obs']."%' order by b.codigo_orden desc " .$limit );
 $total2=0;
