...
<html lang="en">
	<head>
		...
		<script src="assets/js/ace-extra.min.js"></script>
                ...
                <script src="../controlador/control.js?<?php echo rand(1,100) ?>"></script>
		<script src="../controlador/inventario.js?<?php echo rand(1,9999); ?>"></script>
		<script src="../controlador/compras.js?<?php echo rand(1,100) ?>"></script> 
                ...
                <script src="../controlador/produccion.js?<?php echo rand(1,100) ?>"></script>
                <script src="../controlador/cartera.js?<?php echo rand(1,100) ?>"></script>
                <script src="../controlador/popup.js?<?php echo rand(1,100) ?>"></script>
                <script src="../controlador/ventas.js?<?php echo rand(1,100) ?>"></script>
                <script src="../controlador/planeacion.js?<?php echo rand(1,100) ?>"></script>
                <script>
                        function pass()
                         {
					...
					<li class="">
						...
						<ul class="submenu">
								...
								<b class="arrow"></b>
                                                            ...
                                                            <ul class="submenu">
                                                            <li class="">
								<a href="#pla_ped" onclick="pla_ped();">
									<i class="menu-icon fa fa-caret-right"></i>
									Pedidos
								</a>
								<b class="arrow"></b>
