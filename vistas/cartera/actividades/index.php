...
?>
<script src="../vistas/cartera/actividades/funciones.js?<?php echo rand(1,100) ?>"></script>
<div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table>
                ...
                <tr><td>Inicio de la actividad</td>
                    <td>  
                    ...
                    <td>Asignado A:</td> 
                    <td> 
                        <input type="text" value="<?php echo $_SESSION["k_username"]; ?>"  id="asig" class="form-control" disabled> 
                    </td>
                </tr>
                <tr>
                   <td>aviso?</td>
                 ...
                 <tr>
                  ...
                  <tr>
                    <td>seguimiento de la llamada</td> 
