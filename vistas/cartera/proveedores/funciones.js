 ...
 function inv_buscar_codigo(){
     var cod = $("#ter_identifi").val();
      $.ajax({
        type: 'GET',
        data: 'cod='+cod+'&sw=4',
         url: '../vistas/cartera/proveedores/acciones.php',
         success: function(t) {
             var t = eval(t);
    ...
    function mostrar_ter(page){
        ...
        $.ajax({
                ...
                url: '../vistas/cartera/proveedores/lista.php',
            success: function(d){
...
function editar_ter(id){
    ...
    var t = eval(resultado);
       ...
       $("#tipo_cliente").val(t[1]);
        $("#ter_tipo").val(t[2]);
        $("#ter_codverif").val(t[3]);
        $("#ter_nombre").val(t[4]);
        $("#ter_direccion").val(t[5]);
        $("#ter_telefono").val(t[6]);
        $("#ter_movil").val(t[7]);
        $("#ter_dep").val(t[8]);
        $("#ter_muni").val(t[9]);
        $("#ter_pais").val(t[10]);
        $("#ter_fnacido").val(t[11]);
        $("#ter_correo").val(t[12]);
        $("#ter_contacto").val(t[13]);
        $("#ter_desalum").val(t[14]);
        $("#ter_desvidrio").val(t[15]);
        $("#ter_desacero").val(t[16]);
        $("#ter_estado").val(t[17]);
        $("#ter_cliespecial").val(t[18]);
        $("#ter_retefuente").val(t[19]);
        $("#ter_reteica").val(t[20]);
        $("#ter_reteiva").val(t[21]); 
        $("#ter_retcree").val(t[22]);
        $("#ter_asesor").val(t[23]);
 }
});
}
...
function programar(id,nombre){
    window.open("cartera/proveedores/detalles.php?id="+id+"&name="+nombre , "Llamadas", " width= 900 , height=500 ");
}
...
function uppro(id){
     ...
     var ema = $("#ema"+id).val();
        ...
        $.ajax({
            type: 'GET',
            data: 'id='+id+'&doc='+doc+'&nom='+nom+'&cel='+cel+'&ema='+ema+'&sw=8',
            url: '../vistas/cartera/proveedores/acciones.php',
            success: function(resultado){
