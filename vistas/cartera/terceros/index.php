...
?>
<script src="../vistas/cartera/terceros/funciones.js?<?php echo rand(1,100) ?>"></script>
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active" id="marca1">
	   <a data-toggle="tab" href="#lin1">
           ...
           <li id="marca2">
               <a data-toggle="tab" onclick="limpiar_ter();" href="#lin2"><h6><B>Crear usuarios</B></h6></a>
           </li>
        </ul>
 ...
 <table class="table table-hover">
  <tr class="bg-info">
    ...
    <tr>
        ...
        <td><input type="text" placeholder="" class="col-xs-10 col-sm-12"/></td>
          <td>
            <select id="tipod">
        ...
        <td><input type="text" id="est" placeholder="" class="col-xs-10 col-sm-10"  disabled/></td> 
 ...
 <tbody id="mostrar_tabla">
          ...
          <div id="lin2" class="tab-pane fade in">
                   <div class="form-horizontal" role="form">
                    ...
                    <div class="col-sm-9">
                     <select id="ter_tipo"  class="col-xs-10 col-sm-5">
                            <option value=""></option>
                    ...
                    <div class="col-sm-9">
                    <select id="ter_dep" class="col-xs-10 col-sm-5" onchange="cargarmund();">
                    ...
                    <div class="col-sm-9">
                   <select id="ter_muni" class="col-xs-10 col-sm-5">
                      <option value="">Seleccione</option>
                      <?php
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="ter_pais" placeholder="" class="col-xs-10 col-sm-5"/>
                    </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     ...
                     <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Retencion IVA?</label>
                    <div class="col-sm-9">
                     ...
                     <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Retencion CREE</label>
                    <div class="col-sm-9">
                    ...
                    <div class="col-sm-9">
                          <select id="ter_asesor"  class="col-xs-10 col-sm-5">
                              <?php
	 	                     if (isset($_GET['cot'])){
