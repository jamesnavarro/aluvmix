...
$(function(){
    ...
    $('#obranom').change(function(){
             mostrar_pendientes(1);  
     });
   $('#vennom').change(function(){
             mostrar_pendientes(1);  
     });
    $('#numcontra').change(function(){
             mostrar_pendientes(1);  
    });
      $('#fechaval').change(function(){
             mostrar_pendientes(1);  
    });
       $('#estanom').change(function(){
             mostrar_pendientes(1);  
    });
...
function mostrar_pendientes(page){
     ...
     var nomobraa= $("#nomobra").val();
     var vennomm= $("#vennom").val();
     var numcontran= $("#numcontra").val();
     var fechavaln= $("#fechaval").val();
     var estanomn= $("#estanom").val();
  
        $.ajax({
            type: 'GET',
            data: 'nomb='+nombre+'&nomobraa='+nomobraa+'&vennomm='+vennomm+'&numcontran='+numcontran+'&fechavaln='+fechavaln+'&estanomn='+estanomn+'&page='+page,
            url: '../vistas/cartera/contratos/lista.php',
            success: function(resultado){
...
function borrar_doc(id){
    var c = confirm("Va a eliminar el documento?");
     if(c){
         $.ajax({
            type: 'GET',
            data: 'id='+id+'&sw=6',  //
...
function agregar_cot(){
 ...
 var con = confirm("Se va a agregar esta cotizacion al contrato");
 if(con){
    $.ajax({
            type: 'GET',
    ...
    if(fpago===''){
      ...
      if(limi_p===''){
        ...
        $.ajax({
            ...
            url: '../vistas/cartera/contratos/acciones.php', 
            success: function(resultado){
...
function borrar(id){
     var page = $("#page").val();
     var c = confirm("Se eliminara el este usuario?");
     if(c){
         $.ajax({
            type: 'GET',
            data: 'id_a='+id+'&sw=3',  //
...
function imprimir(cot){
    ...
    window.open("../../../vistas/cartera/contratos/print.php?cot="+cot+"&c=&total_item=20&col="+c+"&ciudad=Barranquilla" , "CLIENTES", " width= 600 , height=500 ");
}
...
// MODULO DE ACTIVIDADES
 ...
 function valida_descrip(){
    var valides = $("#descrip_nueva").val();
     if(valides!==''){
...
function borrar_las_acti(id){
    var p = confirm("Se eliminara este contacto?");
     if(p){
         $.ajax({
            type: 'GET',
            data: 'id='+id+'&sw=12',  //
...
function car_detalles(id){
    window.open("../vistas/cartera/contratos/detalles.php?id="+id , "Informe", " width= 1000 , height=600 ");
}

function pdf(id){
    window.open("../vistas/cartera/contratos/pdf.php?id="+id , "resumen", " width= 800 , height=600 ");
}
