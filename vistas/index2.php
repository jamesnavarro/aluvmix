...
<html lang="en">
  ...
  <!-- Informe por tipo de movimientos -->
    <div class="modal fade" id="informe_movimiento" tabindex="-1" role="dialog" aria-labelledby="informe_movimiento">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="informe_movimiento"><i class='glyphicon glyphicon-download'></i> Informe por Movimientos</h4>
            </div>
            <div class="modal-body" style="margin-bottom: 6%;">
           <br>
            <div>
              	<label><b>Tipo de Movimiento: </b></label><input type="text" name="doc" id="doc" onclick="inv_ti_mov_popup2();"><input type="hidden" name="ndoc" id="ndoc">
              </div><br>
             <div>
              	<img src="images/excel.png"> <b>Descargar Documento Excel</b><br><br><br><a href="#download-PDF-Informe" onclick="Informe_mov();"><img src="images/pdf.png"><b>Descargar Documento en Pdf </b></a>
              </div><br>
  ...
  <!-- Informe de entrada y salidas por rango de fecha -->
   <div class="modal fade" id="infom_ent_sal" tabindex="-1" role="dialog" aria-labelledby="infom_ent_sal">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="infom_ent_sal"><i class='glyphicon glyphicon-download'></i>Informe Entrada y salidas</h4>
            </div>
            <div class="modal-body" style="margin-bottom: 6%;">
           <br>
           <div class="form-group">
				...
				<div class="input-group" style="width: 60%;margin-bottom: 2%;">
                                  <input class="form-control date-picker" id="fecin" type="text" data-date-format="yyyy-mm-dd" name="fecin" id="fecin">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				<div class="input-group" style="width: 60%;margin-bottom: 2%;">
                                  <input class="form-control date-picker" id="fecout" type="text" data-date-format="yyyy-mm-dd" name="fecout">
                                  <span class="input-group-addon">
                                    <i class="fa fa-calendar bigger-110"></i>
                                  </span>
                              </div>
              	...
              	<img src="images/excel.png"> <b>Descargar Documento Excel</b><br><br><br><a href="#download-PDF-Kardex" onclick="impre_sal_in();"><img src="images/pdf.png"><b>Descargar Documento en Pdf </b></a>
              </div><br>
  ...
  <?php
  	include 'compras/solicitudes/scritps.php';
  ?>
	</body>
</html>
