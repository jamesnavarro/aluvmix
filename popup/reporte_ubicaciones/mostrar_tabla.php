...
if(isset($_GET['page'])){
     ...
     if($_GET['cod']!=''){
            ...
            $idr = $_GET['idr'];
$request=mysqli_query($con,"SELECT count(*) FROM conf_referencias a, lineas b,relacion_ubicaciones c where a.id_referencia='$idr' and c.stock_ubi!=0 and  a.id_linea_ref=b.id_linea and a.id_referencia=c.id_referencia and a.stock_gen!=0 $cod $des $ref $col $med $lin $ubi ");
            if($request){
            ...
            $last_page = ceil($num_items/$rows_by_page);
                ...
                ?>
                        ...
                        $sql = mysqli_query($con,"SELECT * FROM conf_referencias a, lineas b,relacion_ubicaciones c where a.id_referencia='$idr' and  c.stock_ubi!=0 and a.id_linea_ref=b.id_linea and a.id_referencia=c.id_referencia and a.stock_gen!=0  $cod $des $ref $col $med $lin $ubi ".$limit);
			$item = 0;
