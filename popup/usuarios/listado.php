...
if(isset($_SESSION['k_username'])){
     ...
     $page= $_GET['page'];
            ...
            $request = mysqli_query($con,"SELECT count(*) FROM usuarios where concat(nombre,' ',apellido) like '%".$nom."%' and estado='Activo' ");
...
<div class="table-responsive">          
  <table class="table">
    ...
    $query = mysqli_query($con,"SELECT * FROM usuarios where concat(nombre,' ',apellido) like '%".$nom."%' and estado='Activo' ".$limit);
