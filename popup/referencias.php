...
function pasar(cod,nom,ref,col,med,idr,und,precio){
   window.opener.pasar_referencias(cod,nom,ref,col,med,idr,und,precio);
   window.close();
}
</script>       
</head>
...
<div class="datagrid">
    ...
    <input type="hidden" style="width: 100%" id="carga" disabled value="ENTRADA">
