...
<h4>
    <div class="well well-sm">
        LISTA DE CONTACTOS DE ESTA OBRA
    <div style="float: right">
         ...
         <table class="table">
             ...
             <tr>
                ...
                <tr>
                    ...
                    <td>
                   <div class="input-group">
                    <input type="text" value="<?php echo $_SESSION["k_username"]; ?>" id="regis_arc" class="form-control" readonly >
                    <span class="input-group-addon">Fecha de registro</span>
                    <input type="text"  id="fecha_doc" class="form-control" value="<?php echo date("Y-m-d"); ?>" readonly >
                   </div>
                   </td>
                </tr>
        ...
        <div class="modal-body">
            <table>
                ...
                <tr>
                  ...
                  <tr>
                    <td>Descripcion</td> 
                    <td><textarea id="descrip_nueva" placeholder="motivo de llamada" style="width:100%"></textarea></td>
                  </tr>
                 ...
                 <tr>
                  ...
                  <tr>
                      <td>Contacto<button type="button" onclick="buscar_contacto(<?php echo $p[20] ?>);"><img src="../../imagenes/search.png"></button> </td> 
                     <td>
