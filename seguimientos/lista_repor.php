...
if(isset($_SESSION['k_username'])){ 
   ...
   $fb =' and fec_sistema >= "'.$cfecha.'" and fec_sistema <= "'.$cfin.'" ';
            ...
            $request = mysql_query("SELECT count(*), sum(vtotal_obra) FROM  seguimientos_cot b where  numero_cotizacion_s like '%".$ccotn."%' and concat(nom_temp,' ',nombre_cliente,' ',nombre_obra) like '%".$cnom."%'   and vendedor_cli like '%".$asesr."%' $est and linea_s like '%".$linssa."%' $valores $fb ");
            if($request){
  ...
  <table style="width: 100%" class="table table-hover">
    ...
    <?php
    $query = mysql_query("SELECT * FROM  seguimientos_cot b where numero_cotizacion_s like '%".$ccotn."%' and concat(nom_temp,' ',nombre_cliente,' ',nombre_obra) like '%".$cnom."%'  and vendedor_cli like '%".$asesr."%' $est and linea_s like '%".$linssa."%' $valores $fb order by id_s desc ".$limit);
